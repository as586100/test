...
namespace SalesInput
{
    ...
    public partial class RTSAA
    {
        [System.Diagnostics.CodeAnalysis.SuppressMessage("Microsoft.Usage", "CA2214:DoNotCallOverridableMethodsInConstructors")]
        public RTSAA()
        {
            this.RTSABs = new HashSet<RTSAB>();
        }
    
        public string RAREN { get; set; }
        public string RACNS { get; set; }
        public Nullable<System.DateTime> RADAY { get; set; }
        public Nullable<System.DateTime> RADTS { get; set; }
        public Nullable<System.DateTime> RADTE { get; set; }
        ...
        public virtual ICollection<RTSAB> RTSABs { get; set; }
    }
}
