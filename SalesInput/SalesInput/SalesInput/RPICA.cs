...
namespace SalesInput
{
    ...
    public partial class RPICA
    {
        [System.Diagnostics.CodeAnalysis.SuppressMessage("Microsoft.Usage", "CA2214:DoNotCallOverridableMethodsInConstructors")]
        public RPICA()
        {
            this.RPICBs = new HashSet<RPICB>();
        }
        ...
        public string RAVRM { get; set; }
        public string RARMK { get; set; }
        public string RATYP { get; set; }
        public string RACLO { get; set; }
        ...
        public virtual ICollection<RPICB> RPICBs { get; set; }
    }
}
