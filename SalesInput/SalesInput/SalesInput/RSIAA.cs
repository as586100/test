...
namespace SalesInput
{
    ...
    public partial class RSIAA
    {
        ...
        public string ReCalUser { get; set; }
        public Nullable<System.DateTime> ReCalDate { get; set; }
        public string RACMN { get; set; }
        public string ErpRSIC { get; set; }
        public string ErpRSIM { get; set; }
