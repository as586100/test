...
namespace SalesInput
{
    ...
    public partial class RSICA
    {
        ...
        public string RACSO { get; set; }
        public string RAREO { get; set; }
        public string RACS3 { get; set; }
        public Nullable<int> RAPRN { get; set; }
        public string RACMN { get; set; }
        public string B2bRSIA { get; set; }
        public string B2bRSIM { get; set; }
